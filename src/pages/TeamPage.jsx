...
// NOTE: adjust these paths to where your files actually live.
// If your images are in src/assets/team/* then the path from pages/ is "../assets/team/.."
...
// ⚠️ this filename looks suspicious: ".jpg.jpg" — make sure the file really has that name
...
const TEAM = [
  ...
  },
  {
    ...
    photo: milesPhoto, // verify this filename
...
export default function TeamPage() {
  ...
  // Esc closes modals
  useEffect(() => {
    if (!easterEggModal && !selectedPhoto) return;
    const onKey = (e) => e.key === "Escape" && (setEasterEggModal(null), setSelectedPhoto(null));
  ...
  return (
    <section className="wrap team-page">
      <div className="team-header">
        ...
        <h1 style={{ fontSize: "3rem", fontWeight: 900, margin: "0 0 0.5rem" }}>
          Our Team
        </h1>
        <p style={{ color: "var(--muted)", fontSize: "1.1rem", margin: "0 0 2rem" }}>
      ...
      {easterEggModal && (
        ...
        >
          ...
          >
            ...
            <p style={{ margin: "0 0 1rem", fontSize: "1.1rem", lineHeight: 1.5, color: "var(--text)", fontWeight: 600 }}>
              {easterEggModal.message}
            </p>

            <p style={{ margin: "0 0 1.5rem", fontSize: "0.9rem", color: "var(--muted)", opacity: 0.8 }}>
            ...
            <button
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.boxShadow = `0 6px 20px ${easterEggModal.color}60`;
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.transform = "translateY(0)";
                e.currentTarget.style.boxShadow = `0 4px 15px ${easterEggModal.color}40`;
              }}
            >
      ...
      >
          ...
          >
            ...
            >
              ...
              <div style={{ minWidth: 0, flex: 1 }}>
                <h3 style={{ margin: "0 0 0.25rem", fontSize: "1.3rem", fontWeight: 700 }}>
                  {member.name}
                </h3>
                <p style={{ margin: 0, color: "var(--muted)", fontSize: "0.95rem", fontWeight: 600 }}>
                  {member.role}
                </p>
              </div>
            </div>
        ...
        >
          <button
            ...
            style={{ fontSize: "1rem", padding: "0.8rem 1.2rem", marginBottom: "1.5rem" }}
          >
            ← Back
          </button>
